...
SLOT_REELS = [
	'\U0001f352', '\U0001f34b', '\u2b50', '7\ufe0f\u20e3', '\U0001f48e', '\U0001f514', '\U0001f340',
	'\U0001f347', '\U0001f34a', '\U0001f349', '\U0001f34c', '\U0001f351', '\U0001fad0',
]
SLOT_WEIGHTS = [
	30, 25, 20, 10, 8, 5, 2,
	20, 20, 15, 15, 15, 15,
...
class IRC:
	...
	def cmd_slots(self, nick, chan, args):
		...
		if win:
			...
			self.house_add(bet)
			self.sendmsg(chan, f'  {color(sym_cross, red)} {c_nick(nick)} {c_loss(bet)} {sym_arrow} {c_money(new_chips)}')
